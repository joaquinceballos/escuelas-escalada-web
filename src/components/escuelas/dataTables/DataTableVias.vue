    ...
    <div class="border border-black rounded">
      <table class="table">
        <thead class="thead-dark">
          <tr>
            <th scope="col">{{ $t("message.via.tabla.nombre") }}</th>
            <th scope="col">{{ $t("message.via.tabla.escuela") }}</th>
            <th scope="col">{{ $t("message.via.tabla.grado") }}</th>
            <th scope="col">{{ $t("message.via.tabla.longitud") }}</th>
          </tr>
        </thead>
        <tbody>
